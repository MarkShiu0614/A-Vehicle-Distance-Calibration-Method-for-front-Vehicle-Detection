...
class YOLOV5ToCOCO(object):
    def __init__(self, dir_path):
        ...
        print(f'instances_{self.coco_train}.json')
    ...
    def read_annotation(self, txtfile, img_id,
        ...
        for label_info in allinfo:
            ...
            segmentation, bbox, area, z= self._get_annotation(vertex_info,
                                                            height, width)
            annotation.append({
    ...
    def _get_annotation(vertex_info, height, width):
        cx, cy, w, h, z = [float(i) for i in vertex_info]
        ...
        return segmentation, bbox, area, z


if __name__ == "__main__":
    parser = argparse.ArgumentParser('Datasets converter from YOLOV5 to COCO')
    parser.add_argument('--dir_path', type=str,
                        default='/home/lab602.10977014/.pipeline/10977014/YOLOXt/YOLO2COCO/datasets/newbdd2_1',
