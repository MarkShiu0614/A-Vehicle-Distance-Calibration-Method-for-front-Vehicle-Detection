...
import sys
sys.path.remove('/home/lab602.11077016/.pipeline/11077016/YOLOXt')
sys.path.append("/home/lab602.11077016/.pipeline/11077016/YOLOXt2/")
...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="./datasets/ppt_image/image", help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="exps/example/custom/yolox_x_new_H.py",
        type=str,
        help="pls input your experiment description file",
    )

    
    parser.add_argument("-c", "--ckpt", default="YOLOX_outputs/yolox_x_new_H/best_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
...
class Predictor(object):
    ...
    def inference(self, img):
        ...
        # print("$$$$")
        # print(self.test_size[0], self.test_size[1])
        # print(ratio)
    ...
    def visual(self, output, img_info, cls_conf=0.35):
        ...
        vis_res, resut_list = vis(img, bboxes, scores, z, cls, cls_conf, self.cls_names)    # +txt
...
#             txt_name = os.path.splitext(save_file_name)[0]+".txt"   # save txt
#             print(txt_name)
#             f = open(txt_name, "w")
...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        outputs, img_info = predictor.inference(image_name)
        result = predictor.inference(image_name)
        # print(result)
        if outputs is None or len(outputs) == 0:
            print(f"No objects detected in {image_name}. Skipping...")
            continue
        result_image, result_list = predictor.visual(outputs[0], img_info, predictor.confthre)
