...
import sys
sys.path.append("/home/lab602.3GPU/.pipeline/11077016/YOLOXt/")
...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="./datasets/kitti/val2017", help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="exps/example/custom/yolox_x_nusc_big2.py",
        type=str,
        help="pls input your experiment description file",
    )


    parser.add_argument("-c", "--ckpt", default="YOLOX_outputs/yolox_x_nusc_big2/best_ckpt.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
